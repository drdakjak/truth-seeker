    ...
    return (
        ...
        <div className="mt-6 flex justify-center items-center">
            ...
            <button
                ...
                className={`mr-2 p-2 rounded bg-indigo-600 ${rating === 0 ? 'bg-indigo-900' : 'bg-indigo-600'}`}
            >
            ...
            <button
                ...
                className={`mr-2 p-2 rounded bg-indigo-600 ${rating === 1 ? 'bg-indigo-900' : 'bg-indigo-600'}`}
            >
            ...
            <button
                ...
                className={`p-2 rounded  bg-indigo-600 ${rating === 2 ? 'bg-indigo-900' : 'bg-indigo-600'}`}
            >

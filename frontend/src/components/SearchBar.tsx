    ...
    return (
        <div className="flex-grow relative">
            ...
            <input
                ...
                className="caret-indigo-500 w-full pl-12 pr-12 py-3 md:text-xl text-base border-2 border-indigo-500 rounded-lg focus:ring-2 focus:ring-indigo-800 focus:border-indigo-800"
            />
